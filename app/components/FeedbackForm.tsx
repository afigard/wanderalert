        ...
        <div className="fixed inset-0 flex items-center justify-center text-center bg-black/10 backdrop-blur-xs z-50">
          <div
            className={`rounded-xl p-6 w-[90%] max-w-md shadow-lg border ${
              dark ? "bg-neutral-900 border-neutral-600" : "bg-neutral-100 border-neutral-400"
            }`}
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex justify-center gap-4 mt-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-2xl text-sm text-neutral-100 bg-orange-500 hover:bg-orange-600 cursor-pointer"
                  disabled={status === "sending"}
                >
